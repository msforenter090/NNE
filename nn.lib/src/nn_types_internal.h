...
struct _nn_device_info {
    ...
    cl_uint max_work_group_size;        // Maximum number of work-items in a work-group executing a kernel using the data parallel execution model. 
    size_t max_work_item_sizes[3];      // Maximum number of work-items that can be specified in each dimension of the work-group.
