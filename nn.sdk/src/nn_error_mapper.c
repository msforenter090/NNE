...
const nn_tuple CL_ERROR_MAPPER_GET_PLATFORM_IDS[] = {
    {.key = CL_INVALID_VALUE, .error = {.code = CODE_OK, .message = "clGetPlatformIDs() fail -> CL_INVALID_VALUE.\0"}},
    {.key = CL_SUCCESS, .error = {.code = CODE_OK, .message = "clGetPlatformIDs() success -> CL_SUCCESS\0"}},
    {0}
};
