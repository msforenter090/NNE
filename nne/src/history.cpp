...
const QList<nne::HistoryParam*>& nne::HistoryElement::params() { return _params; }

nne::History::History(const QList<HistoryElement*> &history) : _history(history) { }
const QList<nne::HistoryElement*>& nne::History::history() const { return _history; }

nne::History* loadFromDate(const QFile& historyFile, const QDateTime &from, const QDateTime &to)
{
    return nullptr;
}
